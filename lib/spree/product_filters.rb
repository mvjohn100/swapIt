module Spree
  ...
  module ProductFilters
    ...
    def ProductFilters.price_filter
      ...
      conds = [ [ I18n.t(:under_price, :price => format_price(300))   , v[:amount].lteq(300)],
                [ "#{format_price(300)} - #{format_price(400)}"        , v[:amount].in(300..400)],
                [ "#{format_price(400)} - #{format_price(500)}"        , v[:amount].in(400..500)],
                [ "#{format_price(500)} - #{format_price(600)}"        , v[:amount].in(500..600)],
                [ I18n.t(:or_over_price, :price => format_price(600)) , v[:amount].gteq(600)]]
